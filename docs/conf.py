...
latex_documents = [
    (
        master_doc,
        "Adafruit_CircuitPython_Simple_Text_Display_Library.tex",
        "Adafruit CircuitPython Simple Text Display Library Documentation",
        author,
        "manual",
    ),
]
...
man_pages = [
    (
        master_doc,
        "Adafruit_CircuitPython_Simple_Text_Display_Library",
        "Adafruit CircuitPython Simple Text Display Library Documentation",
        [author],
        1,
    ),
